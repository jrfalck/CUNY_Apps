...
tab1_content = dbc.Container(
    [
        ...
        dbc.Row(
            [
                dbc.Col(controls, md=3,style={"border-right-style":"solid","border-right-color":" dark gray" }),
...
tab3_content = html.Div([
    html.Div([html.H1('Metric Comparison of ALL Countries')],style={'color': colors['text']}),
...
tab4_content = html.Div([
    html.Div([html.H1('Poverty Comparison of Countries')],style={'color': colors['text']}),
