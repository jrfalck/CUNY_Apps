...
df = pd.read_csv('http://www.my-cunymsds.com/data608/poverty2.csv')
...
tab0_content = html.Div([
                    ...
                    dcc.RadioItems(
                        ...
                        value='http://www.my-cunymsds.com/data608/poverty2.csv'
                    ),
                    html.Br(),
                    html.P('Instructions:'),
...
controls_tab1 = dbc.Card(
    [
        ...
        html.Div(
            dcc.Dropdown(
                id='metric-dropdown1',
                options=[{'label': name[0:35], 'value': metric} for name, metric in
    ...
    [
        ...
        html.Div(
            dcc.Dropdown(
                ...
                options=[{'label': name[0:35], 'value': code} for name,
